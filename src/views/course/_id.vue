...
export default {
  ...
  methods: {
    ...
    addtocart(id){
      console.log("添加课程执行了")
      const list = [cartcourse]
      const cartcourse = {}
      cartcourse.id = this.courseInfo.id
      cartcourse.cover = this.courseInfo.cover
      cartcourse.description = this.courseInfo.description
      cartcourse.teacherName = this.courseInfo.teacherName
      cartcourse.price = this.courseInfo.price
      cartcourse.buyCount = this.courseInfo.buyCount
